...
test('explicit canonical Chief origin serves UI and exact Worker identity', async ({ page, request }) => {
  test.skip(!explicitOrigin, 'Remote proof runs only when CHIEF_PUBLIC_ORIGIN is explicitly supplied.');
