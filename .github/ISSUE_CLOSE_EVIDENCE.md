...
The gate reopens the issue when evidence is absent, malformed, not founder-authored, or still reports unresolved risk. Prompt creation, provider output, automation, publishing, or verbal approval do not automatically authorize closure.
